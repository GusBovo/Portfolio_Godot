...
# - Need to think of a solution to not let mouse button event be captured afdter
#   clicking an object
...
# Doesn't need to change collision layer and mask
